...
<<<<<<< HEAD:integration/http/src/main/java/io/seata/integration/http/TransactionPropagationIntercepter.java
            LOGGER.debug("xid in RootContext[{}] xid in HttpContext[{}]", xid, rpcXid);
=======
            LOGGER.debug("xid in RootContext[" + xid + "] xid in BaseHttpContext[" + rpcXid + "]");
>>>>>>> 5a4c31231ae0875765a9812c9c1e12ac92bca68b:integration/http/src/main/java/io/seata/integration/http/spring/TransactionPropagationIntercepter.java
        }
        if (rpcXid != null) {
